...
export default class ProjectileEntity extends Entity {
    ...
    update = (delta: number): void => {
        ...
        this.yaw = ((Math.atan2(this.velocityX, this.velocityZ) * 325.949 + 1024) & 0x7ff) | 0; // TODO maybe
        this.pitch = ((Math.atan2(this.velocityY, this.velocity) * 325.949) & 0x7ff) | 0; // TODO maybe
